...
This mechanism has been integrated into Bitcore-Node-Speed which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/speedpay/insight-api-speed#web-socket-api](https://github.com/speedpay/insight-api-speed#web-socket-api)
* API: [https://github.com/speedpay/insight-api-speed#instantsend-transactions](https://github.com/speedpay/insight-api-speed#instantsend-transactions)
...
By default, the Speed Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Speed Core daemon:
