...
Only requiring some minor changes is speed.cpp.
...
Changes to speed.cpp
----------------------
speed.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
