...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SpeedNetwork") type = SpeedNetwork;
    if(strType == "SpeedNetworkVariable") type = SpeedNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SpeedNetwork) s = "SpeedNetwork";
    if(type == SpeedNetworkVariable) s = "SpeedNetworkVariable";
