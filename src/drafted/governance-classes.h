 ...
 *
 *   // network
 *   CSpeedNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.speed.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSpeedNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SpeedNetwork
// //   -- signature requirements : Key1(User)
// class CSpeedNetworkVariable : public CGovernanceObject
// {
// private:
