    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Speed Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Speed Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  speed-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Speed in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPEED, 0.1 SPEED, 1 SPEED and 10 SPEED -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://speedpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://speedpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Speed Core is shutting down...") + "<br /><br />" +
