    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SPEED-light"), QVariant("light"));
    ui->theme->addItem(QString("SPEED-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SPEED-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SPEED-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SPEED-traditional"), QVariant("trad"));
