    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Speed Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Speed address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and speed: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Speed Core"), this);
    aboutAction->setStatusTip(tr("Show information about Speed Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Speed Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Speed addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Speed addresses"));
    ...
    openAction->setStatusTip(tr("Open a speed: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Speed Core help message to get a list with possible Speed Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Speed Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Speed network", "", count));
    } else {
...
{
    QString strTitle = tr("Speed Core"); // default title
