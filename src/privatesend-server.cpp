...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Speed related functionality
...
/*
    ...
    allow endless transaction that would bloat Speed and make it unusable. To
